      ...
      function drawChart() {
        ...
        for (benefit_item in legend_items) {
          $('#benefits_legend .bar-legend')
            .append('<li><span style="background-color:' + legend_items[benefit_item]['color'] + '" class="test_js_2">' + '<img src="/sites/all/themes/itdash/html/images/legends/legend-' + legend_items[benefit_item]['color'].replace('#', '') + '.jpg" /></span>' + legend_items[benefit_item]['number'] + ' Project Benefits, ' + legend_items[benefit_item]['label'] + '</li>')
        }
